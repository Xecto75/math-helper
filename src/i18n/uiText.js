...
export const UI = {
  en: {
    ...
    back:       '← Back',
    searchLessons: 'Search lessons, topics, levels…',
    noResults:  'Nothing matches that. Try a topic, like "angles" or "fractions".',
    resultOne:  'lesson',
    resultMany: 'lessons',
  ...
  fr: {
    ...
    back:       '← Retour',
    searchLessons: 'Chercher une leçon, un sujet, un niveau…',
    noResults:  'Rien ne correspond. Essaie un sujet, comme « angles » ou « fractions ».',
    resultOne:  'leçon',
    resultMany: 'leçons',
    diff: { beginner: 'Débutant', intermediate: 'Intermédiaire', advanced: 'Avancé' },
  ...
  de: {
    ...
    back:       '← Zurück',
    searchLessons: 'Lektion, Thema oder Niveau suchen…',
    noResults:  'Nichts gefunden. Versuch ein Thema, etwa „Winkel" oder „Brüche".',
    resultOne:  'Lektion',
    resultMany: 'Lektionen',
    diff: { beginner: 'Anfänger', intermediate: 'Mittel', advanced: 'Fortgeschritten' },
  ...
  es: {
    ...
    back:       '← Volver',
    searchLessons: 'Buscar lecciones, temas, niveles…',
    noResults:  'No hay coincidencias. Prueba un tema, como «ángulos» o «fracciones».',
    resultOne:  'lección',
    resultMany: 'lecciones',
    diff: { beginner: 'Principiante', intermediate: 'Intermedio', advanced: 'Avanzado' },
  ...
  it: {
    ...
    back:       '← Indietro',
    searchLessons: 'Cerca lezioni, argomenti, livelli…',
    noResults:  'Nessun risultato. Prova un argomento, come «angoli» o «frazioni».',
    resultOne:  'lezione',
    resultMany: 'lezioni',
    diff: { beginner: 'Principiante', intermediate: 'Intermedio', advanced: 'Avanzato' },
  ...
  pt: {
    ...
    back:       '← Voltar',
    searchLessons: 'Procurar lições, temas, níveis…',
    noResults:  'Nada corresponde. Tenta um tema, como «ângulos» ou «frações».',
    resultOne:  'lição',
    resultMany: 'lições',
    diff: { beginner: 'Iniciante', intermediate: 'Intermédio', advanced: 'Avançado' },
