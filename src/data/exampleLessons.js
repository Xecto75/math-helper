    ...
    pages: [
      {
        ...
        steps: [
          { id: u(), funcId: 'narrate', inputs: { text: 'Sine relates θ to the opposite side and the hypotenuse. Remember SOH: Sine = Opposite over Hypotenuse.' } },
      ...
      },
      {
        ...
        steps: [
          { id: u(), funcId: 'narrate', inputs: { text: 'We know the opposite is 4 and the hypotenuse is 5. Applying arcsin gives us the angle θ directly.' } },
          { id: u(), funcId: 'geo3d-create-2d',        inputs: { id: 'tri', type: 'right-triangle', a: '3', b: '4', c: '', color: 'blue' } },
