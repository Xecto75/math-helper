...
export default function App() {
  ...
  function runDemoFunc(funcId, inputs) {
    switch (funcId) {
      ...
      case 'geo3d-polygon-points':    return demoGeo3dPolygonPoints(inputs.shapeId, inputs.points, inputs.color, inputs.fill)
      ...
      case 'geo3d-mark-angle':        return demoGeo3dMarkAngle(inputs.id, inputs.markId, inputs.from, inputs.vertex, inputs.to, inputs.color, inputs.label, inputs.size)
